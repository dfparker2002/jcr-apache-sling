...
<head>
    ...
    <link href="/etc/aem-training-excercices/css/style.css" rel="stylesheet">
    <script type="text/javascript" src="http://code.jquery.com/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="http://netdna.bootstrapcdn.com/bootstrap/3.1.0/js/bootstrap.min.js"></script>
    <script src="/etc/aem-training-excercices/js/app.js" type="text/javascript" ></script>
</head>
<body class="">
        ...
        <div class="col-xs-12 col-sm-offset-3 col-sm-6">
            <div class="panel panel-default">
                ...
                where the contacts are stored
                 --%>
                <c:set var="contactsResource" value="${sling:getRelativeResource(resource,'ex2')}" />
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/content/excercicesapp2/ex2/*" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name=":redirect" value="/content/excercicesapp2.html" />
